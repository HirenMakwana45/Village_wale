...
class Address2 extends StatefulWidget {
  ...
  @override
  State<Address2> createState() => _Address2();
}

class _Address2 extends State<Address2> {
  ...
  _getseconddynamiclocation() async {
    ...
    if (mounted) {
      ...
      setState(() {
        ...
        addressController.text = Secondlocation!;
      });
  ...
  Widget build(BuildContext context) => WillPopScope(
      onWillPop: () async {
        ...
        Navigator.push(
            context,
            PageTransition(
                type: PageTransitionType.fade, child: const My_Profile()));
  ...
  void callApi() async {
    ...
    String? Address2 = Secondlocation.toString();
    // setState(() {
    //   _isLoading = true;
    // });
    var api = APICallRepository();
    api.addSecondAddress(id, Address2.toString()).then((value) {
      print(value);
      print("YESSSSSSSSSS");
      print("id is " + id);
